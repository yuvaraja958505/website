    ...
    learnMoreLinks.forEach(link => {
        link.addEventListener("click", (event) => {
            ...
            if (content.classList.contains("expanded")) {
                ...
                link.innerHTML = 'LEARN MORE <i class="fa fa-long-arrow-right"></i>';
            } else {
                content.classList.add("expanded");
                link.innerHTML = 'SHOW LESS <i class="fa fa-long-arrow-up"></i>';
            }
        });
    });
});
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Add "scrolled" class for animation
    const handleScroll = () => {
    ...
    const handleMouseMove = (e) => {
        mouseMoveElements.forEach((el) => {
            const speed = el.dataset.speed || 5; // Adjust speed as required
